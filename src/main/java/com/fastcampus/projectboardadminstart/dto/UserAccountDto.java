package com.fastcampus.projectboardadminstart.dto;

import com.fastcampus.projectboardadminstart.domain.UserAccount;
import com.fastcampus.projectboardadminstart.domain.constant.RoleType;
...
public record UserAccountDto(
    ...
    public static UserAccountDto of(String userId, String userPassword, Set<RoleType> roleTypes,
        ...
        return new UserAccountDto(userId, userPassword, roleTypes, email, nickname, memo,
